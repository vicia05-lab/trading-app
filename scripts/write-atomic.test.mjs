...
test("every hand-over the og skill prints is one this script accepts", {
  skip: (!existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md")) || !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/references"))) && "Grok-injected reference docs are not part of the GitHub repository",
}, () => {
